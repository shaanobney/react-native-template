    ...
    return (
      <TabNavigator hidesTabTouch tabBarStyle={tabBarStyle} sceneStyle={sceneStyle}>
        <TabNavigator.Item
          ...
          title={selectedTab === 'feed' ? 'BLOG' : null}
        ...
        <TabNavigator.Item
          ...
          title={selectedTab === 'portfolio' ? 'JUNK' : null}
          renderIcon={() => <Icon style={{paddingBottom: 4}} color={colors.grey2} name='attach-file' size={26} />}
          renderSelectedIcon={() => <Icon color={colors.primary2} name='attach-file' size={26} />}
        ...
        <TabNavigator.Item
          ...
          renderIcon={() => <Icon style={{paddingBottom: 4}} color={colors.grey2} name='nature-people' size={26} />}
          renderSelectedIcon={() => <Icon color={colors.primary2} name='nature-people' size={26} />}
