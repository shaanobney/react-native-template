      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <View style={styles.headerTitleView}>
            <Text style={styles.appTitle}>SHITASS </Text>
            <Text style={styles.appTitleExtra}>TEMPLATE</Text>
          </View>
        </View>
        ...
        <View style={styles.inputs}>
          ...
          <View style={styles.signinView}>
            <TouchableOpacity
              ...
              <Text style={{ fontFamily: 'Neo' }}>LOG IN</Text>
            </TouchableOpacity>
          </View>
          {/* <TouchableOpacity
        ...
        <TouchableOpacity
          ...
          <Text style={styles.aquaFont}>Sign Up</Text>
        </TouchableOpacity>
      </View>
    );
  }
...
let styles = StyleSheet.create({
  ...
  signin: {
      backgroundColor: 'rgba(240, 145, 136, 1)',
      height: 50,
      width: 200,
      alignItems: 'center',
      justifyContent: 'center',
